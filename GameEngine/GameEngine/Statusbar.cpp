...
void Statusbar::draw()
{
	UIUtils::drawRectangle(Vector2f(600, 590+50), Vector2f(100, -100), hoverColor);
	...
	UIUtils::drawRectangle(Vector2f(600, 190+150), Vector2f(100, -100), Color(0xddffdd88));
	UIUtils::drawRectangle(Vector2f(602, 188+150), Vector2f(96, -96), Color(0x44448844));
	UIUtils::drawRectangle(Vector2f(604, 186+150), Vector2f(92, -92), Color(0xddffdd88));
