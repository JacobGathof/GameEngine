...
SettingsPage::SettingsPage()
{
	...
	comps[1] = new Slider(Vector2f(50, 770), Vector2f(300, 10), &GameState::sliderValue, .25f, 1.0f, 0);
	comps[2] = new Slider(Vector2f(50, 720), Vector2f(300, 10), &GameState::ui_blue, 0.0f, 1.0f, 0);
